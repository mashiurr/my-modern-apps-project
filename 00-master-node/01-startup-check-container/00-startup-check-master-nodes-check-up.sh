...
read -p "Press [Enter] to continue to [Step 1] Master-Nodes check up: For “containerd” Installed Nodes:"..."
...
# Pause before next step
read -p "Press [Enter] to continue to [Step 2] Master-Nodes check up: For Kubernetes “kubeadm” Installed Nodes:..."
...
# Pause before next step
read -p "Press [Enter] to continue to [Step 3] Master-Nodes check up: Restart systemctl daemon, Conatinerd & Kublet..."
